...
const styles = StyleSheet.create({
  ...
  dateButton: { backgroundColor: '#1A1A1A', borderRadius: 16, padding: 24, flexDirection: 'row', alignItems: 'center', gap: 16, borderWidth: 0.8, borderColor: '#D4AF37' },
  dateButtonText: { fontSize: 18, fontWeight: '600', color: '#FFFFFF', flex: 1 },
  calendarContainer: { backgroundColor: '#1A1A1A', borderRadius: 16, borderWidth: 0.8, borderColor: '#D4AF37', overflow: 'hidden', padding: 8 },
  selectedDateDisplay: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 16, paddingVertical: 12, backgroundColor: '#1A1A1A', borderRadius: 12, borderWidth: 0.8, borderColor: '#D4AF37' },
  selectedDateText: { fontSize: 16, fontWeight: '600', color: '#D4AF37' },

  noTimeButton: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 16, backgroundColor: '#1A1A1A', borderRadius: 12, borderWidth: 0.8, borderColor: '#D4AF37', marginBottom: 16 },
  ...
  timeSlot: { width: (width - 64) / 3, paddingVertical: 16, backgroundColor: '#1A1A1A', borderRadius: 12, alignItems: 'center', borderWidth: 0.8, borderColor: '#D4AF37' },
  ...
  clubSearchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1A1A1A', borderWidth: 0.8, borderColor: '#D4AF37', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 12, gap: 12, marginBottom: 16 },
  ...
  clubList: { flex: 1 },
  clubItem: { padding: 16, backgroundColor: '#1A1A1A', borderRadius: 12, marginBottom: 12, borderWidth: 0.8, borderColor: '#D4AF37' },
  ...
  optionButton: { paddingVertical: 16, paddingHorizontal: 24, backgroundColor: '#1A1A1A', borderRadius: 12, borderWidth: 0.8, borderColor: '#D4AF37', minWidth: (width - 64) / 3, alignItems: 'center' },
  ...
  optionButtonLarge: { flex: 1, paddingVertical: 32, backgroundColor: '#1A1A1A', borderRadius: 16, alignItems: 'center', borderWidth: 0.8, borderColor: '#D4AF37' },

  rankingHelp: { fontSize: 14, color: '#AAAAAA', marginBottom: 30 },
  rankingInputContainer: { alignItems: 'center', marginBottom: 20 },
  rankingInput: { fontSize: 48, fontWeight: '700', color: '#D4AF37', textAlign: 'center', backgroundColor: '#1A1A1A', borderRadius: 16, borderWidth: 0.8, borderColor: '#D4AF37', paddingVertical: 24, paddingHorizontal: 40, minWidth: 200 },
  ...
  footerButton: { paddingVertical: 16, paddingHorizontal: 24, borderRadius: 12, backgroundColor: '#1A1A1A', borderWidth: 0.8, borderColor: '#D4AF37' },
