...
export default function ExploreScreen() {
  return (
    ...
    >
      ...
      <Text style={styles.subtitle}>Choisissez ce que vous voulez rechercher</Text>
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={styles.actionTitle}>Rechercher une partie</Text>
          </LinearGradient>
        </LinearGradient>
      </Pressable>
      ...
      >
        ...
        >
          ...
          >
            <View style={styles.actionReliefTop} />
            <View style={styles.actionReliefBottom} />
            <Text style={styles.actionTitle}>Rechercher un partenaire de tournoi</Text>
          </LinearGradient>
        </LinearGradient>
      </Pressable>
      ...
      >
        ...
        >
          ...
          >
            <View style={styles.actionReliefTop} />
            <View style={styles.actionReliefBottom} />
            <Text style={styles.actionTitle}>Rechercher un joueur</Text>
          </LinearGradient>
        </LinearGradient>
      </Pressable>
    </ImageBackground>
